    ...
    try {
      ...
      if (midDay != null) {
        ...
        if (masaName == 'ಶ್ರಾವಣ' && !isAdhika) {
          ...
          // Step 2: Find the Friday BEFORE Pournima (always the preceding Friday)
          if (pournimaDay != null) {
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Green dot when Agni is in Bhumi (Shubha)
                              if (data != null && data.agniVasa == 'bhumi')
                                Container(
